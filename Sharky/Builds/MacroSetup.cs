...
namespace Sharky.Builds
{
    public class MacroSetup
    {
        ...
        private void SetupAddOns(MacroData macroData)
        {
        ...
        private void SetupDefensiveBuildings(MacroData macroData)
        {
        ...
        private void SetupMorphs(MacroData macroData)
        {
        ...
        private void SetupProduction(MacroData macroData)
        {
        ...
        private void SetupTech(MacroData macroData)
        {
        ...
        private void SetupUnits(MacroData macroData)
        {
