...
namespace Sharky.Builds.BuildingPlacement
{
    public class TerranBuildingPlacement : IBuildingPlacement
    {
        ...
        private IBuildingPlacement MissileTurretPlacement;
        private SharkyUnitData SharkyUnitData;
        private TerranSupplyDepotGridPlacement TerranBuildingGridPlacement;
        private TerranProductionGridPlacement TerranProductionGridPlacement;
        private TerranTechGridPlacement TerranTechGridPlacement;
        private TerranWallService TerranWallService;
        private IBuildingPlacement WallOffPlacement;
        ...
        private Point2D FindBunkerPlacement(Point2D target, float size, float maxDistance, WallOffType wallOffType, float minimumMineralProximinity)
        {
            Point2D spot;
            if (wallOffType == WallOffType.Terran)
            {
        ...
        private Point2D FindSupplyDepotPlacement(Point2D target, float size, float maxDistance, WallOffType wallOffType, float minimumMineralProximinity)
        {
            Point2D spot;
