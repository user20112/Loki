...
namespace Sharky.Builds.BuildingPlacement
{
    public class TerranSupplyDepotGridPlacement
    {
        ...
        private float FindYStart(float baseY)
        {
        ...
        private Point2D GetValidPoint(float x, float y, float size, int baseHeight, Vector2 mineralLocationVector)
        {
        ...
        private Point2D GetValidPointInColumn(float x, float size, int baseHeight, Vector2 mineralLocationVector, float yStart)
        {
            var y = yStart;
            while (y - yStart < 30)
            {
