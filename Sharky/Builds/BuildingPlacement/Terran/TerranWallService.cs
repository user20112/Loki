...
namespace Sharky.Builds.BuildingPlacement
{
    public class TerranWallService
    {
        ...
        private Point2D GetOpenBunkerPlacement(WallData wallData)
        {
        ...
        private Point2D GetOpenDepotPlacement(WallData wallData, WallOffType wallOffType)
        {
            if (wallData != null)
            {
                var existingDepots = ActiveUnitData.SelfUnits.Values.Where(u => u.Unit.UnitType == (uint)UnitTypes.TERRAN_SUPPLYDEPOT || u.Unit.UnitType == (uint)UnitTypes.TERRAN_SUPPLYDEPOTLOWERED);
        ...
        private Point2D GetOpenProductionAddonPlacement(WallData wallData)
        {
        ...
        private Point2D GetOpenProductionPlacement(WallData wallData)
        {
