...
namespace Sharky.Builds.BuildingPlacement
{
    public class TerranProductionGridPlacement
    {
        ...
        private Point2D GetValidPoint(float x, float y, float size, int baseHeight, IEnumerable<Unit> mineralFields, List<Unit> vespeneGeysers, float maxDistance, Vector2 target, UnitTypes unitType)
        {
            // main building
        ...
        private Point2D GetValidPointInColumn(float x, float size, int baseHeight, float yStart, IEnumerable<Unit> mineralFields, List<Unit> vespeneGeysers, float maxDistance, Vector2 target, UnitTypes unitType)
        {
            Point2D closest = null;
            var y = yStart;
            while (y - yStart < 30)
        ...
        private bool RoomForExitingUnits(float x, float y, float size, UnitTypes unitType)
        {
