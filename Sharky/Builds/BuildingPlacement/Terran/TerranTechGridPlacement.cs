...
namespace Sharky.Builds.BuildingPlacement
{
    public class TerranTechGridPlacement
    {
        ...
        private Point2D GetValidPoint(float x, float y, float size, int baseHeight, IEnumerable<Unit> mineralFields, List<Unit> vespeneGeysers, float maxDistance, Vector2 target, Vector2 baseVector)
        {
            // main building
        ...
        private Point2D GetValidPointInColumn(float x, float size, int baseHeight, float yStart, IEnumerable<Unit> mineralFields, List<Unit> vespeneGeysers, float maxDistance, Vector2 target, Vector2 baseVector)
        {
            Point2D closest = null;
            var y = yStart;
            while (y - yStart < 30)
        ...
        private bool RoomForExitingUnits(float x, float y, float size)
        {
