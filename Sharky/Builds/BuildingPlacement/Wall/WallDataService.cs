...
namespace Sharky.Builds.BuildingPlacement
{
    ...
    {
        private List<MapWallData> BlockMapWallData;
        private List<MapWallData> PartialMapWallData;
        private List<MapWallData> TerranMapWallData;
        ...
        private void AddWallData(MapWallData loadedData, List<WallData> wallData)
        {
        ...
        private List<MapWallData> LoadMapWallData(string folder)
        {
