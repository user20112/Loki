...
namespace Sharky.Builds.BuildingPlacement
{
    public class ProtossProductionGridPlacement
    {
        ...
        private Point2D GetValidPoint(float x, float y, float size, int baseHeight, IEnumerable<Unit> mineralFields, List<Unit> vespeneGeysers, float maxDistance, Vector2 target)
        {
        ...
        private Point2D GetValidPointInColumn(float x, float size, int baseHeight, float yStart, IEnumerable<Unit> mineralFields, List<Unit> vespeneGeysers, float maxDistance, Vector2 target)
        {
            Point2D closest = null;
            var y = yStart;
            while (y - yStart < 30)
