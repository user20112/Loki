...
namespace Sharky
{
    public class TargetPriorityService
    {
        ...
        private float GetKillSeconds(IEnumerable<UnitCalculation> enemies, IEnumerable<UnitCalculation> allies)
        {
        ...
        private bool ShouldTargetDetection(UnitCalculation unitCalculation)
        {
