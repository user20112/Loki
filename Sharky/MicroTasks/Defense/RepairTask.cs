...
namespace Sharky.MicroTasks
{
    public class RepairTask : MicroTask
    {
        ...
        private IIndividualMicroController IndividiualMicroController;
        private MacroData MacroData;
        private Dictionary<ulong, RepairData> RepairData;
        ...
        public RepairTask(LokiBot.BaseLokiBot lokiBot, float priority, bool enabled = true)
        {
            ...
            if (lokiBot.MicroData.IndividualMicroControllers.ContainsKey(UnitTypes.TERRAN_SCV))
            {
                IndividiualMicroController = lokiBot.MicroData.IndividualMicroControllers[UnitTypes.TERRAN_SCV];
            }
            else
            {
                IndividiualMicroController = lokiBot.MicroData.IndividualMicroController;
            }
