...
namespace Sharky.MicroTasks
{
    public class MiningTask : MicroTask
    {
        ...
        private GasMiner GasMiner;
        private bool LowMineralsHighGas;
        private MacroData MacroData;
        private MicroTaskData MicroTaskData;
        private MineralMiner MineralMiner;
        private SharkyUnitData SharkyUnitData;

        public MiningTask(Sharky.LokiBot.BaseLokiBot lokiBot, float priority, MiningDefenseService miningDefenseService, MineralMiner mineralMiner, GasMiner gasMiner)
        {
        ...
        private List<SC2APIProtocol.Action> BalanceGasWorkers(int frame)
        {
        ...
        private IEnumerable<UnitCommander> GetIdleWorkers()
        {
            return UnitCommanders.Where(c => c.UnitRole == UnitRole.None);
        }

        private List<MiningInfo> GetSplitAssignments()
        {
        ...
        private List<SC2APIProtocol.Action> MineWithIdleWorkers(int frame)
        {
            var actions = new List<SC2APIProtocol.Action>();
        ...
        private List<SC2APIProtocol.Action> RecallWorkers(int frame)
        {
            var actions = new List<SC2APIProtocol.Action>();
        ...
        private void ReclaimBuilders(int frame)
        {
        ...
        private void RemoveLostWorkers(int frame)
        {
        ...
        private List<SC2APIProtocol.Action> SplitWorkers(int frame)
        {
            var actions = new List<SC2APIProtocol.Action>();
        ...
        private List<SC2APIProtocol.Action> TransferWorkers(int frame)
        {
            var actions = new List<SC2APIProtocol.Action>();
