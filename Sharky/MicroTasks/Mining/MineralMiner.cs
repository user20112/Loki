...
namespace Sharky.MicroTasks.Mining
{
    public class MineralMiner
    {
        ...
        private List<SC2APIProtocol.Action> GatherMinerals(int frame, MiningInfo miningInfo, Vector2 mineralVector, UnitCommander worker, Vector2 workerVector, List<SC2APIProtocol.Unit> mineralFields)
        {
        ...
        private List<SC2APIProtocol.Action> ReturnMinerals(int frame, Vector2 baseVector, MiningInfo miningInfo, UnitCommander worker, Vector2 workerVector, ulong baseTag)
        {
