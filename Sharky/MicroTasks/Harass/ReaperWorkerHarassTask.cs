...
namespace Sharky.MicroTasks
{
    public class ReaperWorkerHarassTask : MicroTask
    {
        ...
        private IIndividualMicroController MicroController;
        ...
        private List<HarassInfo> HarassInfos { get; set; }

        public override void ClaimUnits(ConcurrentDictionary<ulong, UnitCommander> commanders)
        {
            foreach (var commander in commanders)
            {
                if (!commander.Value.Claimed && commander.Value.UnitRole == UnitRole.Harass && commander.Value.UnitCalculation.Unit.UnitType == (uint)UnitTypes.TERRAN_REAPER)
                {
        ...
        private int HighestFrame(HarassInfo h)
        {
