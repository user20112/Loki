...
namespace Sharky.MicroControllers.Terran
{
    public class CycloneMicroController : IndividualMicroController
    {
        ...
        private bool AvoidDamageWhileLockedOn(UnitCommander commander, Point2D target, Point2D defensivePoint, int frame, float range, out List<SC2APIProtocol.Action> action) // TODO: use unit speed to dynamically adjust AvoidDamageDistance
        {
            action = null;
