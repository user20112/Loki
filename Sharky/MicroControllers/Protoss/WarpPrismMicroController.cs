...
namespace Sharky.MicroControllers.Protoss
{
    public class WarpPrismMicroController : IndividualMicroController
    {
        ...
        public WarpPrismMicroController(LokiBot.BaseLokiBot lokiBot, IPathFinder sharkyPathFinder, MicroPriority microPriority, bool groupUpEnabled)
        ...
        private float ClosestEnemyDistance(UnitCalculation friendly)
        {
        ...
        private bool DetermineMiningAction(UnitCommander commander, int frame, out List<SC2APIProtocol.Action> action)
        {
        ...
        private float DistanceSquared(UnitCalculation unit1, UnitCalculation unit2)
        {
        ...
        private Point2D GetMiningSpot(BaseLocation nexusBase)
        {
            if (nexusBase == null)
            {
                return null;
        ...
        private Point2D GetPickupSpot(Point2D target, Point2D defensivePoint)
        {
        ...
        private UnitCalculation GetSupportTarget(UnitCommander commander, Point2D target, Point2D defensivePoint, IEnumerable<UnitCalculation> supportableUnits = null)
        {
        ...
        private bool NavigateToSupportUnit(UnitCommander commander, Point2D target, int frame, out List<SC2APIProtocol.Action> action)
        {
        ...
        private bool ShouldLoadUnit(UnitCalculation friendly, float healthLimit, int frame)
        {
        ...
        private bool StartWarping(UnitCommander commander, int frame, out List<SC2APIProtocol.Action> action)
        {
            action = null;
        ...
        private bool StopWarping(UnitCommander commander, int frame, out List<SC2APIProtocol.Action> action)
        {
            action = null;
        ...
        private bool UnloadUnits(UnitCommander commander, Point2D defensivePoint, int frame, out List<SC2APIProtocol.Action> action)
        {
            action = null;
        ...
        private void UpdateLoadTimes(UnitCommander commander)
        {
