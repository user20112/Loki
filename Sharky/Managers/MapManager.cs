...
namespace Sharky.Managers
{
    public class MapManager : SharkyManager
    {
        ...
        private int GetDataValueByte(ImageData data, int x, int y)
        {
            int pixelID = x + y * data.Size.X;
        ...
        private void UpdateCreep(ImageData creep)
        {
        ...
        private void UpdateEnemyDpsInRange()
        {
        ...
        private void UpdateInEnemyDetection()
        {
            for (var x = 0; x < MapData.MapWidth; x++)
            {
                for (var y = 0; y < MapData.MapHeight; y++)
        ...
        private void UpdateInEnemyVision()
        {
            for (var x = 0; x < MapData.MapWidth; x++)
            {
                for (var y = 0; y < MapData.MapHeight; y++)
        ...
        private void UpdateInSelfDetection()
        {
            for (var x = 0; x < MapData.MapWidth; x++)
            {
                for (var y = 0; y < MapData.MapHeight; y++)
        ...
        private void UpdateNumberOfAllies(int frame)
        {
            for (var x = 0; x < MapData.MapWidth; x++)
            {
                for (var y = 0; y < MapData.MapHeight; y++)
        ...
        private void UpdatePathBlocked()
        {
            for (var x = 0; x < MapData.MapWidth; x++)
            {
                for (var y = 0; y < MapData.MapHeight; y++)
        ...
        private void UpdateVisibility(ImageData visiblilityMap, int frame)
        {
