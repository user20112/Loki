...
namespace Sharky.Managers
{
    public class ChatManager : SharkyManager
    {
        ...
        private IEnemyPlayerService EnemyPlayerManager;
        private IEnemyNameService EnemyNameService;
        private ChatService ChatService;
        private ActiveChatData ActiveChatData;
        private FrameToTimeConverter FrameToTimeConverter;

        private Dictionary<TypeEnum, int> LastResponseTimes;
        private Dictionary<TypeEnum, int> ChatTypeFrequencies;

        private string ConversationName;
        private PlayerInfo Self;
        private PlayerInfo Enemy;
        private bool GreetingSent;

        private long LastFrameTime;
        private double RuntimeFrameRate;
        ...
        private void UpdateTimeModulation()
        {
            if (LastFrameTime != 0)
            {
